    ...
    components: {
      ...
      schemas: {
        ...
        UpdateWorkRequest: {
          type: "object",
          description:
            "Work update for PUT. Only id and projectId are required; all other fields optional (partial update). Sahneler: POST /api/scenario çıktısını body.scenes olarak gönderin. Editör: body.editorState içinde editorData (videoTrack, textTrack, imageTrack, audioTrack), textOverlays, imageOverlays, exportSettings gönderilir.",
          ...
          properties: {
            ...
            editorState: {
              type: "object",
              description: "Editör state: editorData (videoTrack, textTrack, imageTrack, audioTrack), textOverlays, imageOverlays, exportSettings. PUT ile gönderilir.",
              properties: {
                editorData: {
                  type: "object",
                  properties: {
