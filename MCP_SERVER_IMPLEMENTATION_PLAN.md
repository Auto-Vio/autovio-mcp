...
4. **NPM Paketi**: `@autovio/autovio-mcp-server` olarak publish edilecek
...
Get from cli parameter:
llm-provider: Claude
llm-api-key: 
photo-edit-provider: gemini flash ...
photo-editor-key: ..
```
...
```json
{
  "mcpServers": {
    ...
    "apiToken": "your-api-token-here"
      ...
      "args": ["--autovioBaseUrl", "http://localhost:3001","--autovioApiToken":"your-api-token","--llmProvider":"claude-sonet","--llmApiKey"...]
    }
  }
}
```
